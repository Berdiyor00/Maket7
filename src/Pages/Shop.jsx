...
import Section from "../Components/main1"
...
const Shop = ( ) => {
  ...
  return (
    ...
    <main className="hero">
       <section className="w-full pt-[44px] fixed top-0 left-0 right-0 "id="navbar">
...
<h2 className="font-normal text-[26px] text-[#000] flex items-center gap-[12px] ">My<span>Book</span><span className="w-[1px] h-[24px] bg-[#DEDEDE]"></span> <SlBasketLoaded/> </h2>
        ...
        <section>
          <main>
            ...
            <h1 className=" pl-[40px] md:pl-[0] text-[38px] font-bold uppercase md:font-bold md:uppercase md:text-[75px]" >appreciate your 
author`s work
            </h1>
            <p className="pl-[40px] md:pl-[0] md:text-[25px] md:capitalize font-medium">find your favorite book and read it here for free
  </p>
